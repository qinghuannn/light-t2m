# Copyright (c) 2023, Albert Gu and Tri Dao.
...
def ssd_minimal_discrete(X, A, B, C, block_len, initial_states=None):
    ...
    # B = repeat(B, "b (c l) h d -> b c l h d", l=block_len)
    # C = repeat(C, "b (c l) h d -> b c l h d", l=block_len)
    # X = rearrange(X, "b (c l) h p -> b c l h p", l=block_len)
    # A = rearrange(A, "b (c l) h -> b h c l", l=block_len)
